...
int gBtKnownMACTotal = 4;
char* gBtKnownMAC[4]; //This is set to hold only two MAC adresses
...
void BtInit(void){
  ...
  gBtKnownMAC[0] = "00066644F5F2"; // Change this to one of your MAC addresses
  gBtKnownMAC[1] = "000666434004"; // and this one too
  gBtKnownMAC[2] = "90A4DE9FF398";
  gBtKnownMAC[3] = "0007AB8B842A";
